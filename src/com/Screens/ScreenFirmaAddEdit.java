...
public final class ScreenFirmaAddEdit extends javax.swing.JDialog {

    EntityManager em;
    Maganfir m;
    private final List<Members> ListofMembers;

    public ScreenFirmaAddEdit(java.awt.Frame parent, boolean modal, Maganfir m, EntityManager em) {
        super(parent, modal);
        initComponents();
        this.m = m;
        this.em = em;
